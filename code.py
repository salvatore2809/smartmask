...
#names_sensor_to_rec = ["time","gas","in_mask_temp","pressure","altitude","light","accelerometer_XYZ"]
names_sensor_to_rec = ["time","gas","microphone","light","board_temp","accelerometer_XYZ"]
#setup
state = INIT_STATE
if state == INIT_STATE:
    #try:
